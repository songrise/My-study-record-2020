...
then, $P(X=3)=(\frac{3}{10})^2*(\frac{1}{2})*2+\frac{1}{5}*\frac{3}{10}*(\frac{1}{2})*2+\frac{1}{5}*(\frac{1}{2})^2=$
...
$p(X=1)\times p(Y=10)\ne p(X=1\cap Y=10)$  
$\exist (X,Y),\space p(X)p(Y)\ne p(X\cap Y)$  
So, X and Y are not independent.
## (1.e)

$P(Y=10)=\frac{1}{5}+(\frac{3}{10})^2+(\frac{1}{2})^5\times(\frac{3}{10})\times6+(\frac{1}{2})^{10}$  
...
$(P=6)=(\frac{3}{10})^2*(\frac{1}{2})^4*5+\frac{1}{5}*\frac{3}{10}*(\frac{1}{2})^4*5+\frac{1}{5}*(\frac{1}{2})^5+6*\frac{3}{10}*(\frac{1}{2})^5$
...
By checking the table, we have $z=1.96$  
